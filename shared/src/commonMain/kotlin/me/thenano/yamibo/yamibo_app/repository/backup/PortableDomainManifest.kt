...
internal object PortableDomainManifest {
    val declarations: List<PortableDomainDeclaration> = listOf(
        ...
        included("TagCatalogReadingHistory", appSync = false),
        included("RssSearchReadingHistory", appSync = false),
        included("RssCatalogReadingHistory", appSync = false),
        included("LocalChapterState", appSync = false),
        included("ReadingTimeStat", appSync = true),
        included("FavoriteUpdateEvent", appSync = false),
        included("FavoriteUpdateFidFilter", appSync = false),
        included("FavoriteUpdateCategoryFilter", appSync = false),
