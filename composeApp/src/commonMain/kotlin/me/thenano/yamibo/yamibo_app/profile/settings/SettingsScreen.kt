...
import me.thenano.yamibo.yamibo_app.profile.settings.backup.IPanCloudBackupScreen
    ...
    Scaffold(
        ...
        Column(
            ...
            SettingsItem(
                ...
                title = i18n("網盤雲端備份"),
                subtitle = i18n("登入網盤帳戶，將備份上傳至 yamibo 資料夾"),
                onClick = { navigator.navigate(IPanCloudBackupScreen()) },
            )
            SettingsDivider()
